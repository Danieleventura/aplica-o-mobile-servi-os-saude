...
@Component({
  selector: 'app-medical-speciality',
  templateUrl: './medical-speciality.page.html',
  styleUrls: ['./medical-speciality.page.scss'],
})
export class MedicalSpecialityPage implements OnInit {
    ...
    dataJson: any[];
    countData =0;
    //variable of the specialty chosen by the user
    specialityName ='';
    constructor(private route: ActivatedRoute, private geolocation: Geolocation, private platform: Platform,
      public toastController: ToastController, private modalCtrl: ModalController,
      private callNumber: CallNumber, private statusBar: StatusBar, public modalController: ModalController) {
        this.specialityName = this.route.snapshot.params.id;}
